...
export declare class TileGrid extends Widget implements TileGridModel {
    ...
    protected _onScrollParentScroll(event: JQuery.ScrollEvent<HTMLElement>): void;
