...
export declare class Planner extends Widget implements PlannerModel {
    ...
    protected _onResourceTitleMouseDown(event: JQuery.MouseDownEvent<HTMLDivElement>): void;
    ...
    protected _onGridScroll(event: JQuery.ScrollEvent<HTMLDivElement>): void;
    ...
    protected _onCellMouseDown(event: JQuery.MouseDownEvent<HTMLDivElement>): void;
    ...
    protected _onCellMousemove(mousedownEvent: JQuery.MouseDownEvent<HTMLDivElement>, event: JQuery.MouseMoveEvent<Document>): void;
