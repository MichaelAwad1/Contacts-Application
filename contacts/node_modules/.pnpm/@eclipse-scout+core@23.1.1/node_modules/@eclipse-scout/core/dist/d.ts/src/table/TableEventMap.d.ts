...
import { Cell, Column, DropType, Event, FileDropEvent, Filter, KeyStroke, Menu, NumberColumn, PropertyChangeEvent, Status, Table, TableCheckableStyle, TableControl, TableGroupingStyle, TableHierarchicalStyle, TableRow, Tile, TileTableHeaderBox, ValueField, WidgetEventMap } from '../index';
...
//# sourceMappingURL=TableEventMap.d.ts.map