...
export declare class Tree extends Widget implements TreeModel {
    ...
    protected _showContextMenu(event: JQuery.ContextMenuEvent<HTMLDivElement>): void;
    /** @internal */
    ...
    protected _onNodeDoubleClick(event: JQuery.DoubleClickEvent<HTMLDivElement>): void;
    ...
    protected _onContextMenu(event: JQuery.ContextMenuEvent<HTMLDivElement>): void;
