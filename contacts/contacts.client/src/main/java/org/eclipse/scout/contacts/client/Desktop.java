...
public class Desktop extends AbstractDesktop {
  ...
  @Order(10)
  public static class QuickAccessMenu extends AbstractMenu {
    @Override
  ...
  @Order(20)
  public static class OptionsMenu extends AbstractMenu {
    @Override
    protected String getConfiguredText() {
  ...
  @Order(30)
  public static class UserMenu extends AbstractMenu {
    @Override
    protected String getConfiguredText() {
